...
class ConfigArguments:
    """
    Arguments defining the new model we're about to train.
    """
...
class DataTrainingArguments:
    ...
    datasets_cache_dir: Optional[str] = field(
        default=None, metadata={"help": "The cache dir for local loading of the datasets library."}
    )
    ...
    max_validation_points: Optional[int] = field(
        default=None,
        metadata={"help": "Quick fix to avoid having too big validation sets with huge datasets e.g. OSCAR"},
    )
...
def main():
    ...
    if model_args.config_name:
        config = AutoConfig.from_pretrained(model_args.config_name, **vars(config_args), **config_kwargs)
    else:
